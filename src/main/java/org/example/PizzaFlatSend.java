...
public class PizzaFlatSend {
    ...
    public static void sendPizzaData(String pizzaJson, String filename) {
        Gson gson = new Gson();
        Pizza pizza = gson.fromJson(pizzaJson, Pizza.class); // Deserialize the JSON to a Pizza object

        String csvLine = toDelimitedString(pizza); // Convert Pizza object to CSV line
